...
const MediaList = () => {
    ...
    const mediaCategory = useMemo(() => ["popular", "top_rated"], [])
    ...
    useEffect(() => {
        const getMedias = async () => {
            ...
            const { response, err } = await mediaApi.getList({
                mediaType,
                mediaCategory: mediaCategory[currCategory],
                page: currPage
            })
    ...
    return (
        <>
            <HeroSlide mediaType={mediaType} mediaCategory={mediaCategory[currCategory]}/>
